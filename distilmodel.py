...
from pytorch_pretrained_bert.modeling import DistilBertModel, BertConfig
...
class BertAbsSum(nn.Module):
    def __init__(self, bert_model_path, decoder_config, device):
        ...
        self.bert_encoder = DistilBertModel.from_pretrained(bert_model_path)
    ...
    def forward(self, src, src_mask, tgt, tgt_mask):
        ...
        tgt = tgt[:, :-1]
        tgt_mask = tgt_mask[:, :-1]
        # bert input: DistilBertModel.forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True)
